                ...
                if (!hasHistory) {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            const currentUserName = localStorage.getItem('user_name') || 'viajero';
                            const firstMsg = `¡Hola ${currentUserName}! Qué bueno coincidir 😊 ¿Tenés fechas pensadas para tu viaje? 🧉`;
